...
object KafkaTopics {
    ...
    const val shopCountTopic = "withmarket.shop.validate.count" // redis에 캐싱된 shop의 개수가 맞는지 검증하는데 사용하는 토픽
    const val reviewCountEventTopic = "withmarket.shop.review.count" // review가 작성되어 shop의 정보를 수정하는데 사용하는 토픽
