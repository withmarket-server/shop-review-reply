...
class ShopReviewQueryService(
     ...
     */
    fun findReviewByIdAndName(reviewId: String?, reviewTitle: String?): ResponseEntity<Results.SingleResult<ShopReviewBasicReadDto>> {
     ...
     */
    fun getShopReviewListByShopKey(shopId: String?, shopName: String?): ResponseEntity<Results.MultipleResult<ShopReviewBasicReadDto>> {
        // shopId, shopName 검증
